...
var userTail = (function () {
  ...
  var showAdminFunc =
    function (userInfo) {
      ...
      if(adminHtmlString != '')
        adminHtmlString = '<span class="ua">' + adminHtmlString + '</span>';
